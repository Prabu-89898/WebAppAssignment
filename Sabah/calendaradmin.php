...
<head>
    ...
    <link rel="stylesheet" href="calendaradmin.css">
</head>
<body>
    <div class="container">
        ...
        function build_calendar($month, $year) {
            ...
            while ($currentDay <= $numberDays) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $calendar .= "<a href='delete_event.php?id=" . $row['id'] . "' class='action-button'>Delete</a><br>";
                }
        ...
        <table class="suggested-events-table">
            <thead>
                <tr>
                    <th>Day</th>
                    <th>Events</th>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            <a href='add_suggested_event.php?id=" . $row['id'] . "' class='add-button'>Add</a> |
                            <a href='delete_suggested_event.php?id=" . $row['id'] . "' class='delete-button'>Delete</a>
                        </td>";
                    echo "</tr>";
                }
                ?>
